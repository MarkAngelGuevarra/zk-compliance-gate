...
|:---|:---|:---|
| **Level 1** | Compact contract + Preprod deployment | 🔄 In Progress |
| **Level 2** | React frontend + Lace wallet integration | ⏳ Planned |
| **Level 3** | Full test suite + CI/CD + production dApp | ⏳ Planned |
| **Level 4** | Live MVP + product X profile + documentation | ⏳ Planned |
| **Level 5** | 50 active Preprod users + feedback loop | ⏳ Planned |
| **Level 6** | Mainnet launch + 20 real users | ⏳ Planned |
